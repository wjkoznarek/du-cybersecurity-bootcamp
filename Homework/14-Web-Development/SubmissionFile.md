...
4. What are the three parts of an HTTP response?
  - HTTP Response Status Codes/Line
...
10. What are the advantages of using `curl` over the browser?
  - CLI, can be used anywhere
  - Automation
  - Specify all sorts of request types and other options to test many types of
    traffic. Browsers are limited to the broswer type, host OS and other
    components. 
...
19. Does the request have a user session associated with it?
  - No it does not, there is no cookie header.

20. What kind of data is being sent from this request body?
  - Username/Password, a login attempt
...
24. What kind of content is likely to be in the [page content] response body?
  - It looks like a text based web page based on the `Content-Type` header
